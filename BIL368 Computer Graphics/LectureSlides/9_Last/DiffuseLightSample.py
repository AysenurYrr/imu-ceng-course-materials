...
def init():
    ...
    # Malzeme özelliklerini tanımla: Nesnenin diffuse ışığa nasıl tepki vereceğini belirler.
    glMaterialfv(GL_FRONT, GL_DIFFUSE, [1.0, 0.5, 0.31, 1.0])  # Küre rengini ayarla
...
def main():
    ...
    glutCreateWindow("PyOpenGL Diffuse Lighting Example")
    init()
